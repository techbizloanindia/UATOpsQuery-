      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3 text-sm">
            <span className="text-blue-100">Last updated: {formatLastUpdated()}</span>
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 text-white hover:text-blue-100 hover:bg-blue-600 rounded-lg transition-colors"
          >
            <FaSignOutAlt />
            Logout
          </button>
